...
import { useCopyToClipboard } from "@/app/blogs/lib/hooks/useCopyToClipboard";
import { Language } from "@/app/blogs/lib/utils/types";
          ...
          <div className="not-prose relative">
            ...
            >
              <div className="relative flex text-xs leading-6 ">
                <div className="mt-2 flex flex-none items-center border-b border-t border-b-teal-400 border-t-transparent px-4 py-1 text-sm text-teal-400">
              ...
              <div className="from-midnight code-fade absolute right-0 top-[45px] w-8 bg-gradient-to-l"></div>
            </pre>
          </div>
        )}
      </Highlight>
